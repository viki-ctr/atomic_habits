...
class IsSelfOrReadOnlyTest(TestCase):
    ...
    def test_safe_methods_allowed(self):
        ...
        for method in safe_methods:
            ...
            self.assertTrue(self.permission.has_object_permission(request, None, self.user1))

            self.assertTrue(self.permission.has_object_permission(request, None, self.user2))
    ...
    def test_unsafe_methods_self(self):
        ...
        for method in unsafe_methods:
            ...
            self.assertFalse(self.permission.has_object_permission(request, None, self.user2))
